...
comment on column member.pwd is '회원 패쓰워드';
...
create table cart (
  cseq         number(10)    primary key,  -- 카트번호
  id           varchar2(20)   references member(id),  -- 주문자 아이디
...
--  quantity     number(5)     default 1,        -- 주문 수량
  quantity     number(5)     default 0,        -- 주문 수량
